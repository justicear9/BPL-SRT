...
class UpdateVisitRequest extends FormRequest
{
    ...
    public function authorize(): bool
    {
        ...
        return Gate::allows('update', $visit);
    }
     ...
     */
    public function visitAttributes(Visit $visit): array
    {
        $validated = $this->validated();

        $visitedAt = $this->user()->canManageAllVisits()
        ...
        return [
            ...
            'visit_latitude' => ($lat !== null && $lat !== '') ? (float) $lat : $visit->visit_latitude,
            'visit_longitude' => ($lng !== null && $lng !== '') ? (float) $lng : $visit->visit_longitude,
        ];
    }
}
