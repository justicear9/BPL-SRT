...
@section('content')
  ...
  <div class="card">
    <div class="card-header border-bottom">
      <h5 class="card-title mb-1">{{ __('New visit') }}</h5>
      <small class="text-body-secondary">{{ __('Record the visit, optional order lines, samples, and collections.') }}</small>
    </div>
    <div class="card-body">
