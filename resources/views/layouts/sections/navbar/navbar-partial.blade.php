...
<div class="navbar-brand app-brand demo d-none d-xl-flex py-0 me-4 ms-0">
  <a href="{{ url('/') }}" class="app-brand-link py-1">
    <span class="app-brand-logo demo">@include('_partials.brand-logo')</span>
    @unless (config('branding.logo_hides_template_name'))
  ...
  <ul class="navbar-nav flex-row align-items-center ms-md-auto">
          ...
          <div class="row row-bordered overflow-visible g-0">
            <div class="dropdown-shortcuts-item col">
              <span class="dropdown-shortcuts-icon rounded-circle mb-3">
                <i class="icon-base ti tabler-map-pin icon-26px text-heading"></i>
              </span>
              <a href="{{ route('workspace.visits.index') }}" class="stretched-link">{{ __('Visits') }}</a>
              <small>{{ __('Field visits') }}</small>
            </div>
            <div class="dropdown-shortcuts-item col">
              <span class="dropdown-shortcuts-icon rounded-circle mb-3">
                <i class="icon-base ti tabler-building-store icon-26px text-heading"></i>
              </span>
              <a href="{{ route('workspace.customers.index') }}" class="stretched-link">{{ __('Customers') }}</a>
    ...
    <li class="nav-item navbar-dropdown dropdown-user dropdown">
      ...
      <ul class="dropdown-menu dropdown-menu-end">
        <li>
          <a class="dropdown-item mt-0" href="{{ route('workspace.profile.edit') }}">
        ...
        <li>
          <a class="dropdown-item" href="{{ route('workspace.profile.edit') }}">
            <i class="icon-base ti tabler-user me-3 icon-md"></i><span class="align-middle">{{ __('My profile') }}</span>
          </a>
        </li>
        @if (Auth::check() && class_exists(\Laravel\Jetstream\Jetstream::class) && \Laravel\Jetstream\Jetstream::hasApiFeatures())
        <li>
          <a class="dropdown-item" href="{{ route('api-tokens.index') }}">
            <i class="icon-base ti tabler-settings me-3 icon-md"></i><span class="align-middle">API Tokens</span> </a>
        </li>
        @endif
        @if (Auth::check() && class_exists(\Laravel\Jetstream\Jetstream::class) && Auth::user() instanceof \Illuminate\Database\Eloquent\Model && method_exists(Auth::user(), 'allTeams') && \Laravel\Jetstream\Jetstream::hasTeamFeatures())
        <li>
          <div class="dropdown-divider my-1 mx-n2"></div>
        </li>
        <li>
        ...
        <form method="POST" id="logout-form" action="{{ route('filament.admin.auth.logout') }}">
          @csrf
        </form>
        @else
        <li>
